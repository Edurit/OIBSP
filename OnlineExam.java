...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Who is known as Father of computer science?");  
            jb[0].setText("charles Babbage");jb[1].setText("James Gosling");jb[2].setText("Alan turing");jb[3].setText("Blais Pascal");   
        }  
        if(current==1)  
        {  
